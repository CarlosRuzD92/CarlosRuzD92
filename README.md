...
- Cibernarium (Barcelona Activa) – Frontend para principiantes: maquetación y creación de páginas web con HTML, CSS y Bootstrap.
...
- 🔐 [Mi porfolio](https://github.com/CarlosRuzD92) – Porfolio donde puedes ver un poco más de mí y de mis proyectos.
  
- 🧪 [Otros proyectos personales](https://github.com/CarlosRuzD92?tab=repositories) – Otros proyectos donde experimento con distintas tecnologías.
